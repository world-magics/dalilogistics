...
<div class="mb-5">
    ...
    <a href="{{ route('admin.banner.create') }}" class="btn btn-success float-end"><i class="bi bi-plus-square-dotted"></i></a>
</div>
<div class="card">
    <div class="card-body">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="align-middle">Заглавие</th>
            ...
            <tbody>
                @forelse ($pagination as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.banner.edit', ['id' => $item->id]) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                            <a href="{{ route('admin.banner.delete', ['id' => $item->id]) }}" class="btn btn-danger btn-sm"
