...
<div class="card">
    ...
    <form id="form-project" method="post" action="{{ route('admin.project.update', ['id'=>$project->id]) }}" class="px-4" enctype="multipart/form-data">
        @if (count($errors) > 0)
            <div class="pt-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" name="title[{{ $lang['code'] }}]" required
                                   value="{{ old('title.'. $lang['code'], $project->realTitle[$lang['code']]) }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="short_info" name="short_info[{{ $lang['code'] }}]" required rows="5">
                                {{ old('short_info.'. $lang['code'], $project->realShortInfo[$lang['code']]) }}
                            </textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="tinymce-editor" id="content" name="content[{{ $lang['code'] }}]" required>
                                {{ old('short_info.'. $lang['code'], $project->realContent[$lang['code']]) }}
                            </textarea>
                        </div>
                    </div>
                </div>
