...
<div class="mb-5">
    ...
    <a href="{{ route('admin.about.create') }}" class="btn btn-success float-end"><i class="bi bi-plus-square-dotted"></i></a>
</div>
<div class="card">
    <div class="card-body">
                ...
                @forelse ($pagination as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.about.delete', ['id' => $item->id]) }}" class="btn btn-danger btn-sm"
