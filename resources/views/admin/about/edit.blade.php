...
<div class="card">
    ...
    <form id="form-about" method="post" action="{{ route('admin.about.update', ['id'=> $about->id]) }}" class="px-4">
        @if (count($errors) > 0)
            <div class="pt-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="title" name="title[{{ $lang['code'] }}]" required
                                   value="{{ old('title.'. $lang['code'], $about->realTitle[$lang['code']]) }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="info" name="info[{{ $lang['code'] }}]" required rows="3">
                                {{ old('info.'. $lang['code'], $about->realInfo[$lang['code']]) }}
                            </textarea>
                        </div>
                    </div>
                </div>
