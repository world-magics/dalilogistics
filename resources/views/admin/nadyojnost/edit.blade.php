...
<div class="card">
    ...
    <form id="form-nadyojnost" method="post" action="{{ route('admin.nadyojnost.update', ['id'=> $nadyojnost->id]) }}" class="px-4" enctype="multipart/form-data">
        @if (count($errors) > 0)
            <div class="pt-4">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            {{-- <div class="row mb-3 mt-3">
                ...
                <div class="col-sm-10">
                    <input id="imgurl" class="form-control" type="file" name="imgurl" value="{{ old('imgurl', $nadyojnost->imgurl) }}">
                </div>
            </div> --}}
            @foreach($langs as $key => $lang)
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" name="title[{{ $lang['code'] }}]" required
                                   value="{{ old('title.'. $lang['code'], $nadyojnost->realTitle[$lang['code']]) }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="content" name="content[{{ $lang['code'] }}]" required rows="3">
                                {{ old('content.'. $lang['code'], $nadyojnost->realContent[$lang['code']]) }}
                            </textarea>
                        </div>
                    </div>
                </div>
