...
<div class="mb-5">
    ...
    <a href="{{ route('admin.news.create') }}" class="btn btn-success float-end"><i class="bi bi-plus-square-dotted"></i></a>
</div>
<div class="card">
    <div class="card-body">
        <h5 class="card-title">Список новости</h5>
            ...
            <tbody>
                @forelse ($pagination as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.news.edit', ['id' => $item->id]) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                            <a href="{{ route('admin.news.delete', ['id' => $item->id]) }}" class="btn btn-danger btn-sm"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center">Нет новости</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
