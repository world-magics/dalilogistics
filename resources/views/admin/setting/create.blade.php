...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header">Добавить Настройка</h5>
        <div class="card-body">
            ...
            <form id="form-category" method="post" action="{{ route('admin.setting.store') }}">
                @if (count($errors) > 0)
                    <div class="pt-4">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="key" name="key" required="" value="{{ old('key') }}">
                        </div>
                    </div>
                    @foreach($langs as $key => $lang)
